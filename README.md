...
```
cd existing_repo
git remote add origin https://gitlab.com/kupferdigital/ontologies/mechanical-testing-ontology.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/kupferdigital/ontologies/mechanical-testing-ontology/-/settings/integrations)
